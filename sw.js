const CACHE='malbit-v12';
const ASSETS=['./','./index.html','./app.css','./auth.css','./mobile-study.css','./learning-upgrade.css','./course.css','./course-extra.css','./classroom.css','./real-class.css','./textbook.css?v=10','./course-system.css?v=12','./app.js?v=5','./course.js?v=9','./course-v10.js?v=10','./course-system.js?v=11','./growth-system.js?v=12','./sync.js?v=12','./manifest.webmanifest','./favicon.svg'];
